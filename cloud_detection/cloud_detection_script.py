...
def run_cloud_detection_algorithm(data, params):
    # General Setting
    use_fixed_threshold = params.cloud_detection.use_fixed_threshold # If False, the sensitivity of the radar is used instead
    sensitivity_add_in_dBZ = params.cloud_detection.sensitivity_add_in_dBZ  # Only used if use_fixed_threshold is False (Cloud detection sensitivity = sensitivity + sensitivity_add_in_dbz)
    fixed_threshold_in_dBZ = params.cloud_detection.fixed_threshold_in_dBZ # Only used if use_fixed_threshold is True
    min_cloud_thickness_in_m = params.cloud_detection.min_cloud_thickness_in_m
    min_layer_spacing_in_m = params.cloud_detection.min_layer_spacing_in_m
    debug = False
